 ...
 * 
 */
public class HTTPFileFactory extends FileFactory {
	...
	public boolean isBelongingFileName(FileName fileName) {
		return HTTPFileName.SCHEME.equals(fileName.getScheme())
			|| HTTPFileName.SCHEME_HTTPS.equals(fileName.getScheme());
	}
