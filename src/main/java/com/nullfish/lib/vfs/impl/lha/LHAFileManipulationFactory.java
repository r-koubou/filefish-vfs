...
import com.nullfish.lib.vfs.impl.lha.manipulation.LHAGetAttributesManipulation;
import com.nullfish.lib.vfs.impl.lha.manipulation.LHAGetChildrenManipulation;
import com.nullfish.lib.vfs.impl.lha.manipulation.LHAGetInputStreamManipulation;
import com.nullfish.lib.vfs.impl.lha.manipulation.LHAGetPermissionManipulation;
 ...
 *
 */
public class LHAFileManipulationFactory implements ManipulationFactory {
	...
	public GetAttributesManipulation getGetAttributeManipulation(VFile file)
		...
		return new LHAGetAttributesManipulation(file);
	}
	...
	public SetAttributeManipulation getSetAttributeManipulation(VFile file)
		throws ManipulationNotAvailableException {
		throw new ManipulationNotAvailableException(file, "set attribute");
	}
	...
	public GetPermissionManipulation getGetPermissionManipulation(VFile file)
		throws ManipulationNotAvailableException {
		return new LHAGetPermissionManipulation(file);
	}
	...
	public GetInputStreamManipulation getGetInputStreamManipulation(VFile file)
		throws ManipulationNotAvailableException {
		return new LHAGetInputStreamManipulation(file);
	}
	...
	public GetChildrenManipulation getGetChildrenManipulation(VFile file)
		throws ManipulationNotAvailableException {
		return new LHAGetChildrenManipulation(file);
	}
