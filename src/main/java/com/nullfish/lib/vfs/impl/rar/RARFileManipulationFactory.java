...
import com.nullfish.lib.vfs.impl.rar.manipulation.RARGetAttributesManipulation;
import com.nullfish.lib.vfs.impl.rar.manipulation.RARGetChildrenManipulation;
import com.nullfish.lib.vfs.impl.rar.manipulation.RARGetInputStreamManipulation;
import com.nullfish.lib.vfs.impl.rar.manipulation.RARGetPermissionManipulation;
 ...
 *
 */
public class RARFileManipulationFactory implements ManipulationFactory {
	...
	public GetAttributesManipulation getGetAttributeManipulation(VFile file)
		...
		return new RARGetAttributesManipulation(file);
	}
	...
	public GetPermissionManipulation getGetPermissionManipulation(VFile file)
		throws ManipulationNotAvailableException {
		return new RARGetPermissionManipulation(file);
	}
	...
	public GetInputStreamManipulation getGetInputStreamManipulation(VFile file)
		throws ManipulationNotAvailableException {
		return new RARGetInputStreamManipulation(file);
	}
	...
	public GetChildrenManipulation getGetChildrenManipulation(VFile file)
		throws ManipulationNotAvailableException {
		return new RARGetChildrenManipulation(file);
	}
