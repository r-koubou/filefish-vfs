 ...
 */
public class CommonsHTTPCopyFileManipulation
	 ...
	 * @param file
	 */
	public CommonsHTTPCopyFileManipulation(VFile file) {
		super(file);
	...
	private void copyFile(VFile from, VFile to) throws VFSException {
		...
		try {
			is = new BufferedInputStream(from.getInputStream(this));
			os = new BufferedOutputStream(to.getOutputStream(this));
