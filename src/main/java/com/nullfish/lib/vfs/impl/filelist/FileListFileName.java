 ...
 *
 */
public class FileListFileName extends FileName {
	/**
	 * スキーマ
	 */
	public static final String SCHEME = "list";
	...
	public FileName doCreateFileName(
		...
		String query,
		String fragment) {
		return new FileListFileName(path, baseFileName);
	}
