 ...
 *
 */
public class LHAPermission implements Permission {
	 ...
	 */
	public void setValue(String name, String access, Object value) {
	}
	...
	/* (non-Javadoc)
	 * @see com.sexyprogrammer.lib.vfs.Permission#setPermission(java.lang.String, com.sexyprogrammer.lib.vfs.FileAccess, boolean)
	 */
