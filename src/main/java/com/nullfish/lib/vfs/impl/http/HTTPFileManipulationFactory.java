...
import com.nullfish.lib.vfs.impl.http.manipulation.HTTPCopyFileManipulation;
import com.nullfish.lib.vfs.impl.http.manipulation.HTTPGetAttributesManipulation;
import com.nullfish.lib.vfs.impl.http.manipulation.HTTPGetInputStreamManipulation;
import com.nullfish.lib.vfs.impl.http.manipulation.HTTPGetPermissionManipulation;
 ...
 *
 */
public class HTTPFileManipulationFactory implements ManipulationFactory {
	...
	public GetAttributesManipulation getGetAttributeManipulation(VFile file)
		...
		return new HTTPGetAttributesManipulation(file);
	}
	...
	public GetPermissionManipulation getGetPermissionManipulation(VFile file)
		throws ManipulationNotAvailableException {
		return new HTTPGetPermissionManipulation(file);
	}
	...
	public GetInputStreamManipulation getGetInputStreamManipulation(VFile file)
		throws ManipulationNotAvailableException {
		return new HTTPGetInputStreamManipulation(file);
	}
	...
	public CopyFileManipulation getCopyFileManipulation(VFile file)
		throws ManipulationNotAvailableException {
		return new HTTPCopyFileManipulation(file);
	}
