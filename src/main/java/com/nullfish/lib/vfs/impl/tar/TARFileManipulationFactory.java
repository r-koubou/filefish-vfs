...
import com.nullfish.lib.vfs.impl.tar.manipulation.TARGetAttributesManipulation;
import com.nullfish.lib.vfs.impl.tar.manipulation.TARGetChildrenManipulation;
import com.nullfish.lib.vfs.impl.tar.manipulation.TARGetInputStreamManipulation;
import com.nullfish.lib.vfs.impl.tar.manipulation.TARGetPermissionManipulation;
 ...
 *
 */
public class TARFileManipulationFactory implements ManipulationFactory {
	...
	public GetAttributesManipulation getGetAttributeManipulation(VFile file)
		...
		return new TARGetAttributesManipulation(file);
	}
	...
	public GetPermissionManipulation getGetPermissionManipulation(VFile file)
		throws ManipulationNotAvailableException {
		return new TARGetPermissionManipulation(file);
	}
	...
	public GetInputStreamManipulation getGetInputStreamManipulation(VFile file)
		throws ManipulationNotAvailableException {
		return new TARGetInputStreamManipulation(file);
	}
	...
	public GetChildrenManipulation getGetChildrenManipulation(VFile file)
		throws ManipulationNotAvailableException {
		return new TARGetChildrenManipulation(file);
	}
