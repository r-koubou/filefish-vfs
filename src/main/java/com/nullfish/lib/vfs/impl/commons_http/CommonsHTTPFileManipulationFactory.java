...
import com.nullfish.lib.vfs.impl.commons_http.manipulation.CommonsHTTPCopyFileManipulation;
import com.nullfish.lib.vfs.impl.commons_http.manipulation.CommonsHTTPGetAttributesManipulation;
import com.nullfish.lib.vfs.impl.commons_http.manipulation.CommonsHTTPGetInputStreamManipulation;
import com.nullfish.lib.vfs.impl.commons_http.manipulation.CommonsHTTPGetPermissionManipulation;
 ...
 *
 */
public class CommonsHTTPFileManipulationFactory implements ManipulationFactory {
	...
	public GetAttributesManipulation getGetAttributeManipulation(VFile file)
		...
		return new CommonsHTTPGetAttributesManipulation(file);
	}
	...
	public GetPermissionManipulation getGetPermissionManipulation(VFile file)
		throws ManipulationNotAvailableException {
		return new CommonsHTTPGetPermissionManipulation(file);
	}
	...
	public GetInputStreamManipulation getGetInputStreamManipulation(VFile file)
		throws ManipulationNotAvailableException {
		return new CommonsHTTPGetInputStreamManipulation(file);
	}
	...
	public CopyFileManipulation getCopyFileManipulation(VFile file)
		throws ManipulationNotAvailableException {
		return new CommonsHTTPCopyFileManipulation(file);
	}
